...
public class Cinema3DTest {
    ...
    @Test
    public void whenAddSessionThenNotExistsBetweenAllSessions() {
        Cinema cinema = new Cinema3D();
        assertThatThrownBy(() -> cinema.find(ses -> true))
    ...
    public void whenBuyOnInvalidDateThenGetException() {
        Account account = new AccountCinema();
        Cinema cinema = new Cinema3D();
        Calendar date = new GregorianCalendar(1950, Calendar.JULY, 1);
        assertThatThrownBy(() -> cinema.buy(account, 1, 1, date)).
                isInstanceOf(IllegalArgumentException.class);
    }
}